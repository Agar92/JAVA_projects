...
public class SeccondForm extends JFrame {
    ...
    public SeccondForm(){
        ...
        int l = getIdTextField().getText().length();
        System.out.println(l);
        int progressValue = getProgressBar().getValue();
        if(progressValue >= getProgressBar().getMaximum())
        {
            return;
        }else
        {
            getProgressBar().setValue(l);
        }
        ...
        IdTextField.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                {
                    getProgressBar().setValue(l+length);
                }
            }
        });
    }
